...
import { TrendingUp, Zap, ShieldCheck, Plus, AlertTriangle, CheckCircle2, ArrowLeftRight, Loader2 } from 'lucide-react';
import { useScenarios } from '@/lib/api-hooks';
import Badge from '@/components/ui/Badge';
import Modal from '@/components/ui/Modal';

const impactColors: Record<string, 'positive' | 'warning' | 'negative'> = {
  positive: 'positive',
  neutral: 'warning',
  negative: 'negative',
};
...
export default function ScenariosPage() {
  ...
  return (
    ...
    >
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <Badge variant={impactColors[item.status === 'active' ? 'positive' : item.status === 'draft' ? 'neutral' : 'negative']}>
                      {item.impact}
                    </Badge>
      ...
      <Modal open={showCreateModal} onClose={() => setShowCreateModal(false)} title="Create scenario" size="md">
